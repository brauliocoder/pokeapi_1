  ...
  let pokemon_string_html = `
    <div class="card shadow-sm p-2 h-100" style="width: 18rem;">
      ...
      <div class="card-body d-flex flex-column justify-content-end">
        <a href="" class="modal-call btn btn-danger d-flex justify-content-center" data-pokemon="${name}" data-toggle="modal" data-target="#scrollableModal">¡Quiero saber más de este pokémon!</a>
      </div>
    </div>
  `;
